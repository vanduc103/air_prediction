### ConvLSTM for air pollution interpolation with Meteorological spatiotemporal factor
...
if is_training:
    ...
    tf.summary.scalar('seq2seq_met_loss', loss)
...
model_path = "model/seq2seq_met.ckpt"

# Merge all the summaries and write them out
merged = tf.summary.merge_all()
train_writer = tf.summary.FileWriter('log/seq2seq_met_train', flush_secs=10)
val_writer = tf.summary.FileWriter('log/seq2seq_met_val', flush_secs=10)
...
with tf.Session(config=session_config) as sess:
    ...
    output_path = "output/seq2seq_met.txt"
