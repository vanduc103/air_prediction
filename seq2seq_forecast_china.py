### ConvLSTM for air pollution forecasting with External air pollution sources (China)
...
if is_training_china:
    ...
    tf.summary.scalar('seq2seq_forecast_china_loss', loss)
...
model_path = "model/seq2seq_forecast_china.ckpt"
...
train_writer = tf.summary.FileWriter('log/seq2seq_forecast_china_train', flush_secs=10)
val_writer = tf.summary.FileWriter('log/seq2seq_forecast_china_val', flush_secs=10)
...
with tf.Session(config=session_config) as sess:
    ...
    output_path = "output/seq2seq_forecast_china.txt"
