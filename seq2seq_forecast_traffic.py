### ConvLSTM for air pollution forecasting with Traffic volume spatiotemporal factor
...
if is_training:
    ...
    tf.summary.scalar('seq2seq_forecast_tf_loss', loss)
...
model_path = "model/seq2seq_forecast_tf.ckpt"

# Merge all the summaries and write them out
merged = tf.summary.merge_all()
train_writer = tf.summary.FileWriter('log/seq2seq_forecast_tf_train', flush_secs=10)
val_writer = tf.summary.FileWriter('log/seq2seq_forecast_tf_val', flush_secs=10)
...
with tf.Session(config=session_config) as sess:
    ...
    output_path = "output/seq2seq_forecast_tf.txt"
