### ConvLSTM for air pollution interpolation with driving speed spatiotemporal factor
...
if is_training:
    ...
    tf.summary.scalar('seq2seq_spd_loss', loss)
...
with tf.Session(config=session_config) as sess:
    ...
    output_path = "output/seq2seq_spd.txt"
